...
def encode(lst):
    ...
    for i in lst2:
        ...
        if check_num in dct:
            ...
            lst3.append(dct[num_now])
            dct[check_num] = value_num + 1
            value_num += 1
            num_now = i + "-"
    lst3.append(dct[str(lst2[-1]) + "-"])
    return lst3
...
# print(decode([17, 17, 222, 222, 256, 258, 260, 259, 257, 222],
...
#               '253-': 253, '254-': 254, '255-': 255, '17-17-': 256, '17-222-': 257, '222-222-': 258, '222-17-': 259,
#               '17-17-222-': 260, '222-222-17-': 261, '17-17-222-222-': 262, '222-17-17-': 263, '17-222-222-': 264}
#              ))